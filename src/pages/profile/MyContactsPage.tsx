...
import ToSenderPage from "./ToSenderPage";
import ToReciverPage from "./ToReciverPage";
...
const MyContactsPage = () => {
    ...
    const { allMyContacts: allMyContacts,allMyContactsByDynamic  } = useAppSelector((state) => state.userContactAccessSlice);
                        ...
                        items={[
                            {
                                ...
                                children:  <>
                                    <Table
                                        ...
                                        columns={column}
                                        dataSource={allMyContactsByDynamic.items}
                                        pagination={false}
                                    />
                                    <Pagination
                                        // showQuickJumper
                                        ...
                                        pageSize={pageSize}
                                        current={current}
                                        total={allMyContactsByDynamic.count}
                            ...
                            {
                                label: 'Göndərilən sorğular',
                                key: '2',
                                children: <ToSenderPage/>,
                            },
                            {
                                label: 'Gələn sorğular',
                                key: '3',
                                children:<ToReciverPage/>,
                            },
                        ]}
                    />
                </Card>
