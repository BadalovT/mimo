...
const ToSenderPage = () => {
    ...
    const {allReceiverByDynamic} = useAppSelector((state) => state.userContactAccessSlice);
    ...
    useEffect(() => {
        ...
        dispatch(getAllToReceiverByDynamic({ page: 0, pageSize: 10, obj: {} }));
    }, []);
        ...
        <>
            <>
                <Table
                    ...
                    columns={column}
                    dataSource={allReceiverByDynamic.items}
                    pagination={false}
                />
                <Pagination
                    // showQuickJumper
