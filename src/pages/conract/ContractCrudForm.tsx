...
const ContractCrudForm = ({
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await axios.get(`https://apitest.mimo.az/api/Property/GetByName/${searchValue}`);
          ...
          <Col xs={24} md={24}>
            ...
            >
              <Select
                  ...
                  style={{ width: 200 }}
                  onChange={(value, option) => form.setFieldsValue({ propertyId: value })} // update the form field value
                  value={form.getFieldValue("propertyId")} // get the field value from the form
              />
