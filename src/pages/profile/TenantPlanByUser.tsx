...
import {
    ...
    getAllToSenderByDynamic, GetListContractByPaymentList, GetTenantPlanByUser
...
const {Option} = Select;
const TenantPlanByUser = (contractKey:any) => {
    ...
    const {TenantPlanByUser} = useAppSelector((state) => state.userContactAccessSlice);
    ...
    console.log(TenantPlanByUser, "ListContractByPaymentList")
    return (
        <>
            <>
                <Table
...
export default TenantPlanByUser;
