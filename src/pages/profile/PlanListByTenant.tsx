...
import {
    ...
    getAllToSenderByDynamic, GetListContractByPaymentList, GetListPlanByTenant, GetTenantPlanByUser
...
const {Option} = Select;
const PlanListByTenant = (contractKey:any) => {
    ...
    const {ListPlanByTenant} = useAppSelector((state) => state.userContactAccessSlice);
    ...
    console.log(ListPlanByTenant, "ListContractByPaymentList")
    return (
        <>
            <>
                <Table
...
export default PlanListByTenant;
